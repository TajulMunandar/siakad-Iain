                            ...
                            <div class="row" v-for="(row, index) in tabelRows" :key="index">
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="name" class="form-control" :id="'metode' + index" name="metode[]" v-model="row.metode">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                                        <label :for="'waktu' + index" class="form-label">Waktu</label>
                                        <input type="number" class="form-control" :id="'waktu' + index" name="waktu[]" v-model="row.waktu">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                                        <label :for="'pengalaman' + index" class="form-label">Pengalaman</label>
                                        <input type="name" class="form-control" :id="'pengalaman' + index" name="pengalaman[]" v-model="row.pengalman">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                                        <label :for="'indikator' + index" class="form-label">Indikator</label>
                                        <input type="name" class="form-control" :id="'indikator' + index" name="indikator[]" v-model="row.indikator">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                                        <label :for="'nilai' + index" class="form-label">Nilai</label>
                                        <input type="number" class="form-control" :id="'nilai' + index" name="nilai[]" v-model="row.nilai">
                                    </div>
                                </div>
