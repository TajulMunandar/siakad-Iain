...
@section('content')
                      ...
                      <form action="{{ route('berita-acara-detail.update', $detail->id) }}"
                        ...
                        <div class="modal-body">
                          ...
                          <div class="mb-3">
                            ...
                            <select class="form-select @error('pertemuan') is-invalid @enderror" name="pertemuan" id="pertemuan">
                              @for ($i = 1; $i <= 16; $i++)
  ...
  <x-form_modal id="createModal" title="Tambah Daftar Berita Acara" :route="route('berita-acara-detail.store')"
