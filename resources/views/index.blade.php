            ...
            <div class="container">
                ...
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <a href="#">
                              <img src="{{ asset('template/logo1.png') }}" alt="" width="100%">
                            </a>
                        </h1>
                    </div>
                </div>
                    ...
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <div class="container-sm">
                                <h1 class="hero-title h2-mobile mt-0 is-revealing">SILik-One</h1>
                        ...
                        <div class="hero-illustration">
                            ...
                            <div class="hero-ball hero-ball-1 is-revealing">
                              <div>
                                <a class="button button-primary  button-shadow" href="/survei-skm" style="text-decoration: none; color: #fff">Survei</a>
                              </div>
